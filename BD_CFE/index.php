...
<body>
	...
	<?php	
		...
		echo "<a href='login.php'>Iniciar Secion</a> | <a href='registrar.php'>Regitrarse</a>";
	}
	?>
	<div id="footer">
	Creado por <a href="Proyecto DAWEb/index1.html" title="Mukesh Chapagain">LUIS BRANDON CRISTOBAL RAMIREZ 5J</a>
	</div>
</body>
</html>
